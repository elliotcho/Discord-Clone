...
import {
    ...
    useNewDmReadReceiptSubscription,
...
const SubscriptionWrapper: React.FC<{}> = ({ children }) => {
    ...
    const { data: newDmReadReceiptData } = useNewDmReadReceiptSubscription();
    ...
    useEffect(() => {
        ...
        if(newDmReadReceiptData) {
            cache.evict({ fieldName: 'dmReadReceipts' });
        }
